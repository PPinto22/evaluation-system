...
public class ErrorMessages {
    ...
    public static final String EXAM_EXISTS = "Exam already exists";
    public static final String SUBMISSION_EXISTS = "Submission already exists";
    ...
    public static final String QUESTION_IN_USE = "Question in use";
